...
//Load programme info from json feed http://feeds.rasset.ie/rtelistings/cal/stationID/delta/0000000000/?callback=jsonpCurrentShow 
...
var rows = "10";
	...
	var url = 	"http://feeds.rasset.ie/sitesearch/tracklistinglive/select?q=*:*&wt=json&fq=bdate:[*%20TO%20" + now + "]&fq=channel:" + stationID + "&sort=bdate%20desc&rows="+rows+"&json.wrf=irishRadioApp";
	//var json.wrf = "myFunc";
	//var url = 'http://localhost/localtest/json.json';
