...
function playoutHistory(stationID){	
	...
	var url = 	"http://feeds.rasset.ie/sitesearch/tracklistinglive/select?q=*:*&wt=json&fq=bdate:[NOW/DAY-1DAYS%20TO%20NOW]&fq=channel:" + stationID + "&sort=bdate%20desc&rows="+rows+"&json.wrf=irishRadioApp";
